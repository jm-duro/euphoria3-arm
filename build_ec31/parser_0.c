...
L10:
    ...
    DeRef(_3450);
    _3450 = SEQ_PTR(_15elist)->length;
    if (_3450 <= _elist_base)
        goto L13;
...
int _15CompileType(int _type_ptr)
{
    int _t;
    int _3575 = 0;
    int _0, _1, _2;
    ...
    _2 = (int)SEQ_PTR(_4SymTab);
    _3575 = (int)*(((s1_ptr)_2)->base + _type_ptr);
    RefDS(_3575);
    _0 = _3575;
    _2 = (int)SEQ_PTR(_3575);
    _3575 = (int)*(((s1_ptr)_2)->base + 9);
    Ref(_3575);
    DeRefDS(_0);
    if (binary_op_a(NOTEQ, _3575, 414))
        goto L1;
...
L6:
    ...
    _0 = _3575;
    _2 = (int)SEQ_PTR(_3575);
    _3575 = (int)*(((s1_ptr)_2)->base + 2);
    Ref(_3575);
    DeRefDS(_0);
    _0 = _3575;
    _2 = (int)SEQ_PTR(_4SymTab);
    if (!IS_ATOM_INT(_3575))
        _3575 = (int)*(((s1_ptr)_2)->base + (int)(DBL_PTR(_3575)->dbl));
    else
        _3575 = (int)*(((s1_ptr)_2)->base + _3575);
    RefDS(_3575);
    DeRef(_0);
    _2 = (int)SEQ_PTR(_3575);
...
LA:
    ...
    _3 = (int)(_sym + ((s1_ptr)_2)->base);
    _0 = _3635;
    _3635 = _15CompileType(_type_ptr);
    DeRef(_0);
    _2 = (int)SEQ_PTR(*(int *)_3);
    if (!UNIQUE(_2)) {
        _2 = (int)SequenceCopy((s1_ptr)_2);
...
L2:
    ...
    _3 = (int)(_sym + ((s1_ptr)_2)->base);
    _0 = _3650;
    _3650 = _15CompileType(_type_sym);
    DeRef(_0);
    _2 = (int)SEQ_PTR(*(int *)_3);
    if (!UNIQUE(_2)) {
        _2 = (int)SequenceCopy((s1_ptr)_2);
...
L11:
    ...
    _3 = (int)(_sym + ((s1_ptr)_2)->base);
    _0 = _3784;
    _3784 = _15CompileType(_type_sym);
    DeRef(_0);
    _2 = (int)SEQ_PTR(*(int *)_3);
    if (!UNIQUE(_2)) {
        _2 = (int)SequenceCopy((s1_ptr)_2);
...
LB:
    ...
    *(int *)_2 = _15param_num;
    ...
    if (_15param_num <= _14max_params)
        goto L17;

    // 	    max_params = param_num
    _14max_params = _15param_num;
L17:
